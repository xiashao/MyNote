...
- Conclusion: refer to this wiki, auto zoom is triggered only when the speed changes between different speed limits. By analysing log, the speed is not more than speed limit, therefore, the speed doesn’t changed in the different speed limits.